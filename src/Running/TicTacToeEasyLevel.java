...
public class TicTacToeEasyLevel extends JFrame implements MouseListener{
	...
	private void createGUI() {
		...
		btnChoose.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				new Choose();
				TicTacToeEasyLevel.this.setVisible(false);
			}
		});
	}
	...
	public Move Move(int[][] arr, boolean turn) {
